...
import { Animated, StyleSheet, NativeModules, PanResponder, Platform, View, ViewPropTypes, I18nManager, Keyboard } from 'react-native';
...
class CardStack extends Component<DefaultProps, Props, void> {
  ...
  _render(props: NavigationTransitionProps): React.Element<*> {
    ...
    const gesturesEnabled = false;// this.props.mode === 'card' && Platform.OS === 'ios';
